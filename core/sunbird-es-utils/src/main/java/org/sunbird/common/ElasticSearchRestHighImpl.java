...
/**
 * Implementation of ElasticSearchService providing operations for Elasticsearch.
 * Supports CRUD operations, bulk operations, and search functionality.
 */
public class ElasticSearchRestHighImpl implements ElasticSearchService {
   ...
   * The identifier becomes the document _id.
   *
   * @param index the ES index name
   * @param identifier the unique document identifier
...
//      Map<String, Object> updatedDoc = checkDocStringLength(document);
  ...
  /**
   * Retrieves a document from Elasticsearch by identifier.
   *
   * @param index the ES index name
   * @param identifier the document identifier
   * @param context the request context
   * @return Future containing document data as map, or empty map if not found
   */
  @Override
  ...
  /**
   * Deletes a document from Elasticsearch by identifier.
   *
   * @param index the ES index name
   * @param identifier the document identifier
   * @param context the request context
  ...
  /**
   * Performs a search query on Elasticsearch based on SearchDTO criteria.
   * Supports fields filtering, facets, sorting, and various query options.
   *
   * @param searchDTO the search criteria and options
   * @param index the ES index name
   * @param context the request context
   * @return Future containing search results as map
   */
  @Override
   ...
   *
   * @return Future containing true if healthy, false otherwise
   */
  @Override
  ...
  /**
   * Adds aggregations to the search query based on facet configuration.
   *
   * @param searchSourceBuilder the search source builder
   * @param facets list of facet configurations
   * @return updated search source builder with aggregations
   */
  ...
  /**
   * Updates an existing document or inserts if it doesn't exist (upsert operation).
   *
   * @param index the ES index name
   * @param identifier the document identifier
   ...
   * @param index the ES index name
   * @param context the request context
   * @return Future containing map of document IDs to document data
   */
  @Override
